...
class TestQueryBuilder:
    ...
    def test_build_query_search(self):
        ...
        assert "lower(assets.property_name) LIKE lower('%Building%')" in compiled or "assets.property_name ILIKE" in compiled
        assert "lower(assets.address) LIKE lower('%Building%')" in compiled or "assets.address ILIKE" in compiled
