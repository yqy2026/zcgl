...
async def test_require_perspective_context_should_reject_missing_header_for_business_route() -> None:
...
async def test_require_perspective_context_should_allow_neutral_auth_endpoint_without_header() -> None:
    checker = require_perspective_context()
    request = _build_request(
        method="GET",
...
async def test_require_perspective_context_should_build_owner_effective_party_ids() -> None:
    checker = require_perspective_context()
    request = _build_request(
        method="GET",
        path="/api/v1/analytics/comprehensive",
