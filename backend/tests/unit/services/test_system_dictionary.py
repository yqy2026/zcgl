...
class TestSystemDictionaryService:
    def test_create_dictionary(self, service, mock_db):
        ...
        with patch("src.crud.system_dictionary.system_dictionary_crud.get_by_type_and_code", return_value=None):
            with patch("src.crud.system_dictionary.system_dictionary_crud.create") as mock_create:
                mock_create.return_value = SystemDictionary(id=TEST_DICT_ID, dict_code="code1")
    ...
    def test_create_dictionary_duplicate(self, service, mock_db):
        ...
        with patch("src.crud.system_dictionary.system_dictionary_crud.get_by_type_and_code", return_value=SystemDictionary()):
    ...
    def test_toggle_active_status(self, service, mock_db):
        ...
        with patch("src.crud.system_dictionary.system_dictionary_crud.get", return_value=dict_item):
    ...
    def test_update_sort_orders(self, service, mock_db):
        ...
        with patch("src.crud.system_dictionary.system_dictionary_crud.get", return_value=dict_item):
            ...
            result = service.update_sort_orders(mock_db, dict_type="type1", sort_data=sort_data)
