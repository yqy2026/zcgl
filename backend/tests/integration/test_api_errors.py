...
class TestNotFoundError:
    ...
    def test_not_found_with_resource_info(self) -> None:
        ...
        error = not_found(resource_type="contract", resource_id="test-123")

        assert error.details["resource_type"] == "contract"
        assert error.details["resource_id"] == "test-123"
...
class TestValidationError:
    ...
    def test_validation_error_with_field_list(self) -> None:
        ...
        assert error.details["field_errors"] == {"_errors": field_errors}
...
class TestOperationNotAllowed:
    ...
    def test_operation_not_allowed_with_reason(self) -> None:
        ...
        assert error.details["reason"] == "合同已签署，不能删除"
...
class TestErrorRaising:
    ...
    def test_error_str_representation(self) -> None:
        """Test BaseBusinessError string representation."""
