...
def upgrade() -> None:
    ...
    # 为资产表的高频查询字段添加索引
    op.create_index(
        op.f("ix_assets_ownership_entity"), "assets", ["ownership_entity"], unique=False
    )
    op.create_index(
        op.f("ix_assets_project_name"), "assets", ["project_name"], unique=False
    )
    op.create_index(
        op.f("ix_assets_ownership_status"), "assets", ["ownership_status"], unique=False
    )
    op.create_index(
        op.f("ix_assets_property_nature"), "assets", ["property_nature"], unique=False
    )
    op.create_index(
        op.f("ix_assets_usage_status"), "assets", ["usage_status"], unique=False
    )
