"""Add durable receipts for Organization Party scope batch commits.

Revision ID: 20260806_organization_party_scope_batch_commit_receipts
Revises: 20260806_organization_move_commit_receipts
...
revision = "20260806_organization_party_scope_batch_commit_receipts"
down_revision = "20260806_organization_move_commit_receipts"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.drop_index(
        "ix_organization_party_scope_batch_commits_actor_id",
        table_name="organization_party_scope_batch_commits",
    )
    op.drop_table("organization_party_scope_batch_commits")
