...
from ..services.error_recovery_service import ErrorCategory, ErrorSeverity, RecoveryStrategy
...
ERROR_CLASSIFICATION_RULES = {
    ErrorCategory.NETWORK: [
        ...
        "timedout", "networkunreachable", "hostunreachable"
    ],
    ...
    ErrorCategory.AUTHENTICATION: [
        "auth", "token", "unauthorized", "credential", "login",
        "authentication", "permission", "access", "denied",
        "forbidden", "jwt", "session"
    ],

    ErrorCategory.AUTHORIZATION: [
        "permission", "access", "denied", "forbidden", "unauthorized",
        "role", "privilege", "authorization", "accessdenied"
    ],

    ErrorCategory.FILE_SYSTEM: [
        "file", "path", "directory", "disk", "filesystem",
        "notfound", "permission", "exists", "access",
        "filenotfound", "permissionerror", "isadirectoryerror"
    ],

    ErrorCategory.MEMORY: [
        "memory", "outof", "allocation", "heap", "stack",
        "memoryerror", "allocationerror", "resourceexhausted"
    ],

    ErrorCategory.EXTERNAL_API: [
        "api", "service", "external", "thirdparty", "rate",
        "limit", "unavailable", "down", "timeout",
        "ratelimit", "serviceunavailable", "apierror"
    ],

    ErrorCategory.PROCESSING: [
        "processing", "parse", "transform", "convert", "encode",
        "decode", "format", "syntax", "structure",
        "parsingerror", "formaterror", "encodingerror"
    ],

    ErrorCategory.BUSINESS_LOGIC: [
        "business", "logic", "rule", "constraint", "policy",
        "workflow", "process", "state", "condition",
        "businessexception", "ruleviolation"
    ],

    ErrorCategory.SYSTEM: [
        "system", "internal", "server", "critical", "fatal",
        "exception", "panic", "crash", "shutdown",
        "systemerror", "internalexception", "criticalerror"
    ]
}
...
SEVERITY_CONFIG = {
    ...
    ErrorSeverity.MEDIUM: {
        'categories': [ErrorCategory.NETWORK, ErrorCategory.AUTHENTICATION, ErrorCategory.EXTERNAL_API],
