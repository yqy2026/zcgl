...
from .assets import router as assets_router  # noqa: F401
from .auth import router as auth_router  # noqa: F401
from .backup import router as backup_router  # noqa: F401
from .custom_fields import router as custom_fields_router  # noqa: F401
from .defect_tracking import router as defect_tracking_router  # noqa: F401
from .dictionaries import router as dictionaries_router  # noqa: F401
from .enum_field import router as enum_field_router  # noqa: F401

# 修复Excel模块导入 - 使用正确的router名称
from .excel import router as excel_router  # noqa: F401
from .history import router as history_router  # noqa: F401

# from .missing_apis import missing_apis_router  # Removed - module doesn't exist  # noqa: F401
from .monitoring import router as monitoring_router  # noqa: F401
from .occupancy import router as occupancy_router  # noqa: F401
from .operation_logs import router as operation_logs_router  # noqa: F401
from .organization import router as organization_router  # noqa: F401
from .ownership import router as ownership_router  # noqa: F401
from .pdf_import_routes import router as pdf_import_router  # noqa: F401
from .project import router as project_router  # noqa: F401
from .rent_contract import router as rent_contract_router  # noqa: F401
from .roles import router as roles_router  # noqa: F401

# 修复statistics模块导入 - 使用正确的router名称
from .statistics import router as statistics_router  # noqa: F401

# 系统设置模块可能不存在，需要检查
# from .system_settings import router as system_settings_router  # noqa: F401
...
from .system_dictionaries import router as system_dictionaries_router  # noqa: F401
...
# from .pdf_import_unified import router as pdf_import_router  # noqa: F401
# from .organization_permissions import router as organization_permissions_router  # 已删除  # noqa: F401
# from .rbac import router as rbac_router  # 已删除  # noqa: F401
# from .dynamic_permissions import router as dynamic_permissions_router  # 已删除  # noqa: F401
# from .audit_dashboard import router as audit_dashboard_router  # 已删除  # noqa: F401
# from .permission_delegation import router as permission_delegation_router  # 已删除  # noqa: F401
# from .multi_tenant import router as multi_tenant_router  # 已删除  # noqa: F401
# from .dynamic_permission_api import router as dynamic_permission_api_router  # 已删除  # noqa: F401
# from .audit_dashboard_api import router as audit_dashboard_api_router  # 已删除  # noqa: F401
# from .test_assets import router as test_assets_router  # 已删除  # noqa: F401
# from .security_monitor import router as security_monitor_router  # 已删除  # noqa: F401
# from .ocr_analysis import router as ocr_analysis_router  # 已删除  # noqa: F401
...
# from .simple_pdf_import import router as pdf_import_router  # 已删除  # noqa: F401
# api_router.include_router(
#     pdf_import_router,
#     prefix="/pdf_import",
#     tags=["PDF合同导入"])
