...
async def calculate_occupancy_rate(
    ...
    try:
        ...
        # 计算利用率（出租+自用）
        utilization_rate = ((rented_count + self_used_count) / total_rentable) * 100 if total_rentable > 0 else 0
