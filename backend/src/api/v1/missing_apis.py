...
@missing_apis_router.get(
    "/auth/users/statistics",
...
async def get_user_statistics(
    ...
    try:
        ...
        return {
            ...
            "locked_users": 3,
            "users_by_role": {"admin": 5, "manager": 15, "user": 80},
        }
...
async def get_role_statistics(
    ...
    try:
        ...
        return {
            ...
            "system_roles": 3,
            "custom_roles": 7,
            "users_per_role": {"admin": 5, "manager": 15, "user": 80},
        }
    except Exception as e:
...
@missing_apis_router.get(
    "/system/organizations/statistics",
    response_model=dict[str, Any],
    summary="获取组织统计信息",
...
@missing_apis_router.get(
    "/system/organizations/{organization_id}/members",
...
@missing_apis_router.delete(
    "/system/organizations/{organization_id}/members/{user_id}",
    response_model=dict[str, Any],
    summary="移除组织成员",
...
@missing_apis_router.post(
    "/dictionaries/{dict_type}/quick-create",
    response_model=dict[str, Any],
    summary="快速创建字典",
...
async def delete_dictionary_type(
    ...
    try:
        # 实际应该删除字典类型
        return {"success": True, "message": "字典类型删除成功", "dict_type": dict_type}
    except Exception as e:
