    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                "priority_issues": [r for r in system_recommendations if r["priority"] == "high"]
            }
        }
    except Exception as e:
    ...
    try:
        ...
        for session in active_sessions:
            ...
            if session.session_id in pdf_processing_monitor.active_operations:
                start_time = pdf_processing_monitor.active_operations[session.session_id]
                operation_info = {
...
async def get_monitoring_dashboard(
    ...
    try:
        ...
        for session in active_sessions:
            status = session.status.value
            if status not in dashboard_data["activity_summary"]["session_status_breakdown"]:
                dashboard_data["activity_summary"]["session_status_breakdown"][status] = 0
    ...
    try:
        return {
            ...
            "data": {
                ...
                "total_performance_metrics": len(pdf_processing_monitor.performance_metrics),
