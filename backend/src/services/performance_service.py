...
class PerformanceService:
    ...
    def get_asset_statistics_optimized(self) -> Dict[str, Any]:
        ...
        ownership_stats = self.db.query(
            ...
            func.count(Asset.id).label('count')
        ).group_by(Asset.ownership_status).all()
        ...
        return {
            ...
            'occupancy_rate': (
                ...
                if stats.total_rentable_area else 0
            ),
            'by_nature': [
                {
        ...
        try:
            ...
            if 'assets' in table_names:
                ...
                indexes_to_create = [
                    ...
                    ("idx_assets_actual_property_area", "assets", "actual_property_area"),
                ...
                # 复合索引
                composite_indexes = [
                    ("idx_assets_ownership_nature", "assets", "ownership_entity, property_nature"),
                    ("idx_assets_status_nature", "assets", "usage_status, property_nature"),
                ]
