...
class APIDocGenerator:
    ...
    def _add_method_to_docs(self, path: str, method: str, endpoint, docstring: str,
                           path_params: List, query_params: List, tags: List[str]):
        """添加HTTP方法到文档"""
    ...
    def _generate_tags_info(self):
        ...
        tag_details = {
            ...
            "权属方": {
                "description": "权属方管理相关接口，包括权属方信息的维护和查询"
            },
            "统计": {
                "description": "数据统计分析接口，提供各种维度的数据统计和报表功能"
            },
            "Excel": {
                "description": "Excel导入导出功能，支持异步处理和任务跟踪"
            },
            "PDF": {
                "description": "PDF文件处理功能，支持智能提取和批量导入"
            },
            "任务管理": {
                "description": "异步任务管理，提供任务状态跟踪和历史记录查询"
            },
            "系统管理": {
                "description": "系统配置和字典管理功能"
            }
        }
        ...
        common_schemas = {
            "Asset": {
                ...
                "properties": {
                    ...
                    "actual_property_area": {"type": "number", "description": "实际房产面积"},
            ...
            "Task": {
                ...
                "properties": {
                    ...
                    "created_at": {"type": "string", "format": "date-time", "description": "创建时间"},
                    "started_at": {"type": "string", "format": "date-time", "description": "开始时间"},
