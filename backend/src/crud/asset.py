...
from sqlalchemy import Select, delete, false, insert, or_, select
...
from .asset_query import AssetQueryMixin
...
class AssetCRUD(AssetQueryMixin, CRUDBase[Asset, AssetCreate, AssetUpdate]):
    """资产CRUD操作类 - 优化版本"""
