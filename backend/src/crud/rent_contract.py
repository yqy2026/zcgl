...
class CRUDRentLedger(CRUDBase[RentLedger, RentLedgerCreate, RentLedgerUpdate]):
    ...
    def generate_monthly_ledger(
        ...
        for year_month in months:
            ...
            rent_term = self._get_rent_term_for_date(rent_terms, month_date)

            if rent_term:
                due_amount = rent_term.total_monthly_amount or rent_term.monthly_rent
