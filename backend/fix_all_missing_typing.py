...
def main():
    ...
    for py_file in src_dir.rglob("*.py"):
        ...
        try:
            ...
            needs_typing = any([
                'Dict[' in content and 'Dict' not in content and 'from typing import' in content,
                'List[' in content and 'List' not in content and 'from typing import' in content,
                'Optional[' in content and 'Optional' not in content and 'from typing import' in content,
                'Union[' in content and 'Union' not in content and 'from typing import' in content,
                'Callable[' in content and 'Callable' not in content and 'from typing import' in content,
                'Any[' in content and 'Any' not in content and 'from typing import' in content
            ])
            ...
            if needs_typing:
                ...
                if needed_imports:
                    if 'from typing import' in content:
                        ...
                        current_imports = re.search(r'from typing import ([^\n]+)', content)
                        if current_imports:
                            existing_imports = [imp.strip() for imp in current_imports.group(1).split(',')]
                            ...
                            content = content.replace(current_imports.group(0), new_import_line)
                    else:
