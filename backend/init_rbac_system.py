...
from src.models.rbac import Role, Permission, UserRoleAssignment, RolePermissionAssignment
from src.models.auth import User
from src.models.organization import Organization
from src.crud.rbac import RoleCRUD, PermissionCRUD, UserRoleAssignmentCRUD
...
def create_basic_permissions(db: Session):
    ...
    permissions_data = [
        # 用户管理权限
        ("user_list", "查看用户列表", "查看系统中的所有用户信息", "user", "list", False),
        ...
        # 资产管理权限
        ("asset_list", "查看资产列表", "查看系统中的所有资产信息", "asset", "list", False),
        ...
        # 权属方管理权限
        ("ownership_list", "查看权属方列表", "查看权属方信息", "ownership", "list", False),
        ("ownership_create", "创建权属方", "创建新的权属方", "ownership", "create", False),
        ("ownership_update", "更新权属方", "更新权属方信息", "ownership", "update", False),
        ("ownership_delete", "删除权属方", "删除权属方记录", "ownership", "delete", False),
        ("ownership_view", "查看权属方详情", "查看权属方详细信息", "ownership", "read", False),

        # 统计分析权限
        ("statistics_basic", "基础统计", "查看基础统计信息", "statistics", "read", False),
        ("statistics_advanced", "高级统计", "查看高级统计分析", "statistics", "analyze", True),
        ("statistics_export", "导出统计", "导出统计数据", "statistics", "export", True),

        # 组织管理权限
        ("organization_list", "查看组织列表", "查看组织架构信息", "organization", "list", False),
        ("organization_create", "创建组织", "创建新组织", "organization", "create", False),
        ("organization_update", "更新组织", "更新组织信息", "organization", "update", False),
        ("organization_delete", "删除组织", "删除组织", "organization", "delete", False),
        ("organization_view", "查看组织详情", "查看组织详细信息", "organization", "read", False),
        ("organization_manage", "管理组织", "管理组织结构和权限", "organization", "manage", False),

        # 权限管理权限
        ("permission_list", "查看权限列表", "查看系统权限列表", "permission", "list", False),
        ("permission_create", "创建权限", "创建新的权限", "permission", "create", False),
        ("permission_update", "更新权限", "更新权限信息", "permission", "update", False),
        ...
        # 高级权限
        ("dynamic_permission", "动态权限", "管理动态权限分配", "dynamic_permission", "manage", True),
        ("permission_delegation", "权限委托", "委托权限给其他用户", "permission_delegation", "delegate", True),
        ("multi_tenant", "多租户管理", "管理多租户配置", "multi_tenant", "manage", True),
        ("advanced_audit", "高级审计", "查看高级审计报告", "advanced_audit", "analyze", True),
    ]

    permission_crud = PermissionCRUD()
    created_count = 0

    for code, name, description, resource, action, is_system, requires_approval in permissions_data:
        try:
            permission_data = {
                "name": code,
                "display_name": name,
...
def create_permission_assignments(db: Session):
    ...
    role_permission_data = [
        ("admin", ["user_list", "user_create", "user_update", "user_delete", "user_view",
                   "asset_list", "asset_create", "asset_update", "asset_delete", "asset_view", "asset_export",
                   "project_list", "project_create", "project_update", "project_delete", "project_view",
                   "ownership_list", "ownership_create", "ownership_update", "ownership_delete", "ownership_view",
                   "statistics_basic", "statistics_advanced", "statistics_export",
                   "organization_list", "organization_create", "organization_update", "organization_delete", "organization_view", "organization_manage",
                   "permission_list", "permission_create", "permission_update", "permission_delete",
                   "role_list", "role_create", "role_update", "role_delete", "role_assign",
                   "audit_list", "audit_export",
                   "system_config", "system_backup", "system_restore",
                   "dynamic_permission", "permission_delegation", "multi_tenant", "advanced_audit"]),

        ("manager", ["user_list", "user_update", "user_view",
                   "asset_list", "asset_update", "asset_view", "asset_export",
                   "project_list", "project_update", "project_view",
                   "ownership_list", "ownership_update", "ownership_view",
                   "statistics_basic", "statistics_export",
                   "organization_list", "organization_update", "organization_view",
                   "role_list", "role_view",
                   "audit_list"]),

        ("operator", ["user_list", "user_view",
                   "asset_list", "asset_view",
                   "project_list", "project_view",
                   "ownership_list", "ownership_view",
                   "statistics_basic",
                   "organization_list", "organization_view",
                   "role_list", "role_view"]),

        ("viewer", ["user_list", "user_view",
                   "asset_list", "asset_view",
                   "project_list", "project_view",
                   "ownership_list", "ownership_view",
                   "statistics_basic",
        ...
        ("auditor", ["user_list", "user_view",
                   "asset_list", "asset_view",
                   "project_list", "project_view",
                   "ownership_list", "ownership_view",
                   "statistics_basic", "audit_list", "audit_export"]),
    ]
