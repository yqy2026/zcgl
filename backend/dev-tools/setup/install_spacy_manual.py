...
def method4_local_install():
    ...
    print("1. 手动下载模型文件：")
    print(
        "   - 中文模型: https://github.com/explosion/spacy-models/releases/download/zh_core_web_sm-3.7.1/zh_core_web_sm-3.7.1.tar.gz"
    )
    print(
        "   - 英文模型: https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.7.1/en_core_web_sm-3.7.1.tar.gz"
    )
    print()
...
def test_models():
    ...
    try:
        ...
        try:
            ...
            test_text = (
                "This is a test text to verify the English spaCy model works correctly."
            )
            doc = nlp(test_text)
            print("✅ 英文模型测试成功")
            print(f"   测试文本: {test_text}")
