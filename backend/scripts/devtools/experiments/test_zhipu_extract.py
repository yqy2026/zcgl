...
Usage:
    ...
    python scripts/devtools/experiments/test_zhipu_extract.py --pdf path/to/contract.pdf
...
async def test_zhipu_extraction():
    ...
    if not pdf_path_str:
        ...
        print(
            "  1. Command-line: python scripts/devtools/experiments/test_zhipu_extract.py --pdf path/to/file.pdf"
        )
