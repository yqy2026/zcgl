...
class AnalyticsExportService {
  ...
  async exportToExcel(data: AnalyticsExportData, filename?: string): Promise<void> {
    try {
      ...
      const finalFilename =
        filename !== null && filename !== undefined && filename !== '' ? filename : defaultFilename;
   ...
   */
  exportToPDF(data: AnalyticsExportData, filename?: string): Promise<void> {
    try {
...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ${data.property_nature_distribution
                  .map(
                    item =>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ${data.ownership_status_distribution
                  .map(
                    item =>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ${data.usage_status_distribution
                  .map(
                    item =>
                      `<tr><td>${item.status}</td><td>${item.count}</td><td>${item.percentage}</td></tr>`
                  )
