...
export const CONTRACT_GROUP_ROUTES = {
  ...
  NEW_CONTRACT: (id: string) => `/contract-groups/${id}/contracts/new`,
} as const;

export const CONTRACT_CENTER_ROUTES = {
  LIST: '/contract-center',
  NEW: '/contract-center/new',
  IMPORT: '/contract-center/import',
  DETAIL_PATH: '/contract-center/:id',
  EDIT_PATH: '/contract-center/:id/edit',
  NEW_CONTRACT_PATH: '/contract-center/:id/contracts/new',
  DETAIL: (id: string) => `/contract-center/${id}`,
  EDIT: (id: string) => `/contract-center/${id}/edit`,
  NEW_CONTRACT: (id: string) => `/contract-center/${id}/contracts/new`,
} as const;
