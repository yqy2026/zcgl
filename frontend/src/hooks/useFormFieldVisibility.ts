...
const assetFieldVisibilityRules: FieldVisibilityRule<AssetFormData>[] = [
  ...
  // 有业态类别时显示接收模式
  {
    ...
    condition: values =>
      values.business_category !== null &&
      values.business_category !== undefined &&
      values.business_category.trim() !== '',
  ...
  // 有五羊项目名称时显示接收协议日期
  {
    ...
    condition: values =>
      values.wuyang_project_name !== null &&
      values.wuyang_project_name !== undefined &&
      values.wuyang_project_name.trim() !== '',
