        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={8}>
            <Card size="small" title="1. 下载模板">
              <Text>点击&ldquo;下载&rdquo;按钮获取对应的数据导入模板文件</Text>
            </Card>
          </Col>
          <Col xs={24} md={8}>
            ...
            <div style={{ marginTop: '16px', textAlign: 'center' }}>
              <Space>
                <Button
                  ...
                  icon={<DownloadOutlined />}
                  onClick={() => {
                    void handleDownloadTemplate(previewTemplate);
...
const Statistic: React.FC<{
  ...
  <div>
    <div style={{ color: '#00000073', fontSize: '14px', marginBottom: '4px' }}>{title}</div>
    <div
      style={{
        fontSize: '24px',
        fontWeight: 'bold',
    ...
    >
      ...
      {suffix !== null && suffix !== undefined && suffix !== '' && (
        <span style={{ fontSize: '14px', marginLeft: '4px' }}>{suffix}</span>
      )}
    </div>
  </div>
);
