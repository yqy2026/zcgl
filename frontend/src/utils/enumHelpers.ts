...
import { PropertyNature, UsageStatus, OwnershipStatus, BusinessModel, TenantType, OperationStatus } from '@/types/asset'
...
export const PropertyNatureGroups: EnumGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: PropertyNature.NON_COMMERCIAL_PUBLIC_HOUSING, label: '非经营-公配房', color: 'green' },
    ]
  },
  {
    label: '配套物业',
    options: [
      ...
      { value: PropertyNature.NON_COMMERCIAL_SUPPORTING_TOWN, label: '非经营-配套镇', color: 'orange' },
      { value: PropertyNature.NON_COMMERCIAL_SUPPORTING_HOUSING, label: '非经营类-配套', color: 'orange' },
    ]
  },
  {
    label: '处置类物业',
...
export const UsageStatusGroups: EnumGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: UsageStatus.VACANT_PLANNING, label: '空置规划', color: 'orange', description: '规划中空置' },
      { value: UsageStatus.VACANT_RESERVED, label: '空置预留', color: 'orange', description: '预留空置' },
      { value: UsageStatus.VACANT_SUPPORTING, label: '空置配套', color: 'orange', description: '配套空置' },
      { value: UsageStatus.VACANT_SUPPORTING_SHORT, label: '空置配', color: 'orange', description: '空置配套（简称）' },
  ...
  },
  {
    label: '特殊用途',
    options: [
      { value: UsageStatus.PUBLIC_HOUSING, label: '公房', color: 'purple', description: '公共住房' },
      { value: UsageStatus.PUBLIC_FACILITY, label: '公配', color: 'purple', description: '公共配套设施' },
      { value: UsageStatus.SUPPORTING_FACILITY, label: '配套', color: 'purple', description: '配套设施' },
    ]
  },
  {
    label: '待处理状态',
    options: [
      { value: UsageStatus.PENDING_DISPOSAL, label: '待处置', color: 'red', description: '等待处置' },
      { value: UsageStatus.PENDING_HANDOVER, label: '待移交', color: 'red', description: '等待移交' },
    ]
  },
  {
    label: '其他',
...
export const OwnershipStatusOptions: EnumOption[] = [
  ...
  { value: OwnershipStatus.PARTIAL, label: '部分确权', color: 'orange', description: '部分业权已确认' },
  { value: OwnershipStatus.CANNOT_CONFIRM, label: '无法确认业权', color: 'red', description: '业权无法确认' },
]
