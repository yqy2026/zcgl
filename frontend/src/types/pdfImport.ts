...
// 会话状态接口
export interface PdfImportSessionProgress {
  success: boolean;
  session_id: string;
  status: string;
  progress: number;
...
// 文件上传响应接口
export interface PdfImportFileUploadResponse {
  success: boolean;
  message: string;
  session_id?: string;
...
// 完整结果接口
export interface PdfImportCompleteResult {
  session_id: string;
  file_info: FileInfo;
  extraction_result: PdfImportExtractionResult;
  validation_result: PdfImportValidationResult;
  matching_result: MatchingResult;
  semantic_validation: ContractValidationReport;
  processing_summary: PdfImportProcessingSummary;
  summary: PdfImportConfidenceScores;
  recommendations: string[];
...
// 提取结果接口
export interface PdfImportExtractionResult {
  success: boolean;
...
// 置信度分数接口
export interface PdfImportConfidenceScores {
...
// 处理摘要接口
export interface PdfImportProcessingSummary {
...
// 系统能力接口
export interface PdfImportSystemCapabilities {
...
// 系统信息响应接口
export interface PdfImportSystemInfoResponse {
  success: boolean;
  message: string;
  capabilities: PdfImportSystemCapabilities;
  extractor_summary?: {
    method: string;
    description: string;
    engines: string[];
