...
export const UserManagementGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.USER_VIEW]}>
    {children}
  </PermissionGuard>
)

export const RoleManagementGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.ROLE_VIEW]}>
    {children}
  </PermissionGuard>
)

export const OrganizationManagementGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.ORGANIZATION_VIEW]}>
    {children}
  </PermissionGuard>
)

export const SystemLogsGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.SYSTEM_LOGS]}>
    {children}
  </PermissionGuard>
)

export const AssetManagementGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.ASSET_VIEW]}>
    {children}
  </PermissionGuard>
)

export const AssetCreateGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.ASSET_CREATE]}>
    {children}
  </PermissionGuard>
)

export const RentalManagementGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <PermissionGuard permissions={[PERMISSIONS.RENTAL_VIEW]}>
    {children}
  </PermissionGuard>
)