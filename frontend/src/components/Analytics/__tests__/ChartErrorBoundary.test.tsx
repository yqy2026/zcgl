...
vi.mock('antd', () => ({
  Alert: ({ message, description, type, showIcon, action, style }: any) => (
    <div data-testid="alert" data-type={type} data-message={message} data-show-icon={showIcon} style={style}>
      {description}
      {action}
    </div>
  ),
...
describe('ChartErrorBoundary - 错误处理测试', () => {
  ...
  it('应该捕获子组件错误', async () => {
    ...
    const element = React.createElement(ChartErrorBoundary, {},
...
describe('ChartErrorBoundary - fallback测试', () => {
  ...
  it('应该使用自定义fallback', async () => {
    ...
    const element = React.createElement(ChartErrorBoundary, { fallback },
      React.createElement(ThrowError)
    )
    expect(element).toBeTruthy()
  })
  ...
  it('fallback可以为null', async () => {
    ...
    const element = React.createElement(ChartErrorBoundary, { fallback: null },
      React.createElement(ThrowError)
    )
    expect(element).toBeTruthy()
  })
...
describe('ChartErrorBoundary - onError回调测试', () => {
  ...
  it('错误时应该调用onError', async () => {
    ...
    const element = React.createElement(ChartErrorBoundary, { onError: handleError },
      React.createElement(ThrowError)
    )
    expect(element).toBeTruthy()
  })
