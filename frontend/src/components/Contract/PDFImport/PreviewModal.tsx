                    ...
                    {enhancedStatus !== undefined && (
                        <div>
                            ...
                            <ul>
                                ...
                                <li>建议：{enhancedStatus.document_analysis?.recommendations?.join('；') ?? '无'}</li>
                            </ul>
                            ...
                            <ul>
                                <li>总体质量：{enhancedStatus.final_results?.extraction_quality?.overall_quality ?? 0}/10</li>
                                <li>验证分数：{enhancedStatus.final_results?.validation_score ?? 0}/10</li>
                                <li>处理方法：{enhancedStatus.final_results?.extraction_quality?.processing_methods?.join('、') ?? '未知'}</li>
                            </ul>
                        </div>
                    )}
                </div>
