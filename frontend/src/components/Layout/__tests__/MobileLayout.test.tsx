...
describe('MobileLayout - 基础属性测试', () => {
  ...
  it('应该支持children属性', async () => {
    ...
    const element = React.createElement(MobileLayout, null, children);
    expect(element).toBeTruthy();
  });

  it('应该接受空children', async () => {
    const MobileLayout = (await import('../MobileLayout')).default;
    const element = React.createElement(MobileLayout, null, null);
    expect(element).toBeTruthy();
  });
});
...
describe('MobileLayout - 边界情况测试', () => {
  ...
  it('应该处理undefined children', async () => {
    const MobileLayout = (await import('../MobileLayout')).default;
    const element = React.createElement(MobileLayout, null, undefined);
    expect(element).toBeTruthy();
  });
  ...
  it('应该处理空字符串children', async () => {
    const MobileLayout = (await import('../MobileLayout')).default;
    const element = React.createElement(MobileLayout, null, '');
    expect(element).toBeTruthy();
  });
});
