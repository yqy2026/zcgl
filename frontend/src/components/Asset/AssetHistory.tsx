...
const AssetHistory: React.FC<AssetHistoryProps> = ({ assetId }) => {
  ...
  const renderFieldChanges = (
    ...
    const allFields = new Set([
      ...Object.keys(oldValues != null ? oldValues : {}),
      ...Object.keys(newValues != null ? newValues : {}),
    ]);
        ...
        {selectedHistory && (
          <Spin spinning={detailLoading}>
            <Descriptions bordered column={1} labelStyle={{ width: '120px' }}>
              ...
              {((selectedHistory.reason != null && selectedHistory.reason.length > 0) ||
                (selectedHistory.description != null &&
                  selectedHistory.description.length > 0)) && (
