...
const AssetAreaSummary: React.FC<AssetAreaSummaryProps> = ({
  ...
  // 调试信息
  console.log('AssetAreaSummary 调试信息:', {
    analyticsData,
    area_summary: analyticsData?.area_summary,
    hasAnalyticsData,
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12} md={8} lg={6}>
            <Statistic
              ...
              valueStyle={{
                color: summary.averageOccupancyRate >= 80 ? '#52c41a' :
                       summary.averageOccupancyRate >= 60 ? '#faad14' : '#ff4d4f'
              }}
              precision={2}
            />
          </Col>
