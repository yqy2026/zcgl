  ...
  const handleContractChange = useCallback(
    (contractId: string) => {
      ...
      if (selectedContract) {
        ...
        form.setFieldsValue({
          tenant_name:
            selectedContract.tenant_name !== null && selectedContract.tenant_name !== undefined
              ? selectedContract.tenant_name
              : '',
          tenant_contact:
            selectedContract.tenant_contact !== null &&
            selectedContract.tenant_contact !== undefined
              ? selectedContract.tenant_contact
              : '',
          tenant_type:
            selectedContract.tenant_id !== null &&
            selectedContract.tenant_id !== undefined &&
            selectedContract.tenant_id !== ''
              ? 'enterprise'
              : 'individual',
          lease_contract_number:
            selectedContract.contract_number !== null &&
            selectedContract.contract_number !== undefined
              ? selectedContract.contract_number
              : '',
          contract_start_date:
            selectedContract.start_date !== null &&
            selectedContract.start_date !== undefined &&
            selectedContract.start_date !== ''
              ? dayjs(selectedContract.start_date)
              : undefined,
          contract_end_date:
            selectedContract.end_date !== null &&
            selectedContract.end_date !== undefined &&
            selectedContract.end_date !== ''
              ? dayjs(selectedContract.end_date)
              : undefined,
          monthly_rent:
            selectedContract.monthly_rent_base !== null &&
            selectedContract.monthly_rent_base !== undefined
              ? selectedContract.monthly_rent_base
              : undefined,
          deposit:
            selectedContract.total_deposit !== null && selectedContract.total_deposit !== undefined
              ? selectedContract.total_deposit
              : undefined,
        });
      } else {
