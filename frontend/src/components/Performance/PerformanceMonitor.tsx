...
const PerformanceMonitor: React.FC = () => {
  ...
  const collectWebVitals = useCallback(() => {
    ...
    if (fcpEntries !== null && fcpEntries !== undefined && fcpEntries.length > 0) {
  ...
  const getPerformanceScore = (metric: number, thresholds: [number, number]) => {
    if (metric <= thresholds[0]) {
      return { score: 'good', color: 'green' };
    }
    if (metric <= thresholds[1]) {
      return { score: 'needs-improvement', color: 'orange' };
    }
            ...
            <Card title="Web Vitals 指标" size="small">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
                <Statistic
                  ...
                  valueStyle={{
                    color:
                      metrics.fcp !== null && metrics.fcp !== undefined && !isNaN(metrics.fcp)
                ...
                <Statistic
                  ...
                  valueStyle={{
                    color:
                      metrics.lcp !== null && metrics.lcp !== undefined && !isNaN(metrics.lcp)
                ...
                <Statistic
                  ...
                  valueStyle={{
                    color:
                      metrics.fid !== null && metrics.fid !== undefined && !isNaN(metrics.fid)
                ...
                <Statistic
                  ...
                  valueStyle={{
                    color:
                      metrics.cls !== null && metrics.cls !== undefined && !isNaN(metrics.cls)
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
                ...
                <div>
                  <Statistic
                    title="网络类型"
                    value={
                      metrics.effectiveType !== null &&
                      metrics.effectiveType !== undefined &&
