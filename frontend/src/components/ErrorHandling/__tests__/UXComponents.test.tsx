...
describe("UX Components", () => {
  ...
  describe("ConfirmDialog", () => {
    it("renders delete confirmation dialog", () => {
      render(<ConfirmDialog type="delete" visible={true} itemName="测试项目" />);
    ...
    it("calls confirm and cancel callbacks", async () => {
      ...
      render(
        <ConfirmDialog type="delete" visible={true} onConfirm={onConfirm} onCancel={onCancel} />,
      );
  ...
  describe("ProgressIndicator", () => {
    ...
    it("renders circle progress correctly", () => {
      render(<ProgressIndicator type="circle" percent={75} status="success" />);
    ...
    it("renders steps progress correctly", () => {
      ...
      render(<ProgressIndicator type="steps" steps={steps} current={1} />);
