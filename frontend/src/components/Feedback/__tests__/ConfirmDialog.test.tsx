...
vi.mock('antd', () => ({
  Modal: ({ title, open, onOk, onCancel, okText, cancelText, children, okButtonProps, width, centered, maskClosable, confirmLoading }: any) => (
    <div
      data-testid="modal"
      data-open={open}
      data-width={width}
  ...
  Typography: {
    ...
    Paragraph: ({ children, type }: any) => (
      <p data-testid="paragraph" data-type={type}>{children}</p>
    ),
  },
