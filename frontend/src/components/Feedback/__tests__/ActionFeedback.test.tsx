...
vi.mock('antd', () => ({
  Button: ({ children, icon, type, size, onClick }: any) => (
    <button data-testid="button" data-type={type} data-size={size} onClick={onClick}>
  ...
  Alert: ({ type, showIcon, icon, message, description, closable, onClose: _onClose }: any) => (
    <div data-testid="alert" data-type={type} data-show-icon={showIcon} data-closable={closable}>
