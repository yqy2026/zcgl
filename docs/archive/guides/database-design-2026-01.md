# 土地物业资产管理系统 - 数据库设计文档（历史快照）

> Historical snapshot. 本文保留 2026-01 期间的数据库设计上下文，不再作为当前字段、状态或表结构基线。当前数据库设计入口见 `docs/architecture/database-design.md`，字段契约以 `docs/specs/domain-model.md` 为准。
