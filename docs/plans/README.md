...
| [2026-03-15-m1-closure-acceptance-plan.md](2026-03-15-m1-closure-acceptance-plan.md) | M1 收口与可验收推进 | 🔄 进行中 | 聚焦 PTY 真缺口、ANA 前端验收、AUTH 计划收尾与 SSOT 对齐 |
| [2026-03-16-ai-code-debt-remediation-plan.md](2026-03-16-ai-code-debt-remediation-plan.md) | AI 生成代码技术债务修复 | 📋 待评审 | 消除 32 处函数重复、拆分超大文件、统一错误处理 |
| [2026-03-17-perspective-simplification-plan.md](2026-03-17-perspective-simplification-plan.md) | 视角机制简化：全局切换器 → 菜单入口路由 | 📋 待评审 | 移除 ~1500 行视角专用代码，改为路由内联视角 |
| [2026-03-17-perspective-workspace-isolation-plan.md](2026-03-17-perspective-workspace-isolation-plan.md) | 视角简化实施前工作区隔离 | 📋 待评审 | 先冻结当前混合 WIP，再从干净 develop 派生 planning worktree |
